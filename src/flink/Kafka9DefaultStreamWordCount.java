...
public class Kafka9DefaultStreamWordCount implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(Kafka9DefaultStreamWordCount.class);
	static {
	...
	public void run() throws Exception {
		...
		dataStream.addSink(new FlinkKafkaProducer09<>(PropertiesStack
				.getResultKafkaTopic(), new KeyedSerializationSchema<String>() {
			@Override
	...
	public static void main(String[] args) {
		try {
			...
			new Kafka9DefaultStreamWordCount().run();
